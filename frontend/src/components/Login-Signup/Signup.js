            ...
            <div className="form-container">
              <div className="row sgnUp ">
                <div className="col-md-6 right-divider pdding">
                  <h3 className="lead-text mn-txt"> Join us </h3>
                  <br />
                  <h3 className="lead-text mn-txt"> By </h3>
                  <br />
                  <h3 className="lead-text mn-txt"> Creating </h3>
                  <br />
                  <h3 className="lead-text mn-txt"> Your Account! </h3>
                  <br />
                </div>
